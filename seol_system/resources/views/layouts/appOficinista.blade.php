<!DOCTYPE html>
<html class="bg-profile-header"style="background-color: #9198d9; ">
    <head>
        <meta charset="UTF-8" />
        ...
        <style>
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(to bottom, rgba(145, 152, 217, 0.6), transparent 100%);
            z-index: -1;
            }
            ...
            <div class="items-center flex-grow flex-basis-full">
                <ul class="flex flex-col pl-0 mb-auto">
                    ...
                    <li class="mt-0.5 w-full">
                        ...
                        <a class="py-2.7   dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                            href=" {{route('oficinista.solicitudesVista')}} ">
                            <div
                                class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-house-door-fill relative top-0 text-sm  text-blue-500" viewBox="0 0 16 16">
                        ...
                        <a class="py-2.7   dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                            href=" {{route('oficinista.enprocesoVista')}} ">
                            <div
                                class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-house-door-fill relative top-0 text-sm  text-blue-500" viewBox="0 0 16 16">
                        ...
                        <a class="py-2.7   dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                            href="  {{route('oficinista.HistorialVista')}}">
                            <div
                                class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-house-door-fill relative top-0 text-sm  text-blue-500" viewBox="0 0 16 16">
                        ...
                        <a class="py-2.7   dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                            href="  {{route('oficinista.plantilla')}}">
                            <div
                                class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-house-door-fill relative top-0 text-sm  text-blue-500" viewBox="0 0 16 16">
                                ...
                                <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                                    ...
                                    @auth
                                        <li class="flex items-center">
                                            <a href="{{route('oficinista.perfil')}}  "
