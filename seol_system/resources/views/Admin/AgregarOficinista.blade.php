        ...
        <div
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="flex-none w-auto max-w-full px-3 my-auto">
                    <div class="h-full">
                        <h5 class="mb-1 dark:text-black">Agregar Oficinista </h5>
        ...
        <div class="flex flex-wrap -mx-3">
            ...
            <div class="w-full max-w-full px-3 shrink-0 md:w-8/12 md:flex-0">
                <div
                    ...
                    <form action="{{ route("admin.oficinista.store")}}" method="POST" novalidate>
                        @csrf
                        <div class="flex-auto p-6">
                            <div class="flex flex-wrap -mx-3">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="username"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Contraseña</label>
